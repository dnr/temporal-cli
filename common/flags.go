...
var SharedFlags = []cli.Flag{
	...
	&cli.BoolFlag{
		...
		EnvVars:  []string{"TEMPORAL_TLS_DISABLE_HOST_VERIFICATION"},
		Category: CategoryGlobal,
	},
	&cli.StringFlag{
	...
	&cli.StringFlag{
		...
		EnvVars:  []string{"TEMPORAL_CODEC_ENDPOINT"},
		Category: CategoryGlobal,
	},
	&cli.StringFlag{
		Name:     FlagCodecAuth,
		...
		EnvVars:  []string{"TEMPORAL_CODEC_AUTH"},
		Category: CategoryGlobal,
	},
	&cli.StringFlag{
